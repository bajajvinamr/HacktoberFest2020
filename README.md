...
### 9. Quick Tips
To do a simple pull request, go to the README file and make an edit, then put your comment and propose changes. This will trigger a pull request to submit your first pull request for Hacktoberfest.
